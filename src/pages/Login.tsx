...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-stretch" id="login_viewport_split">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#080C17] text-white p-16 flex-col justify-between relative overflow-hidden border-r border-white/5">
        
        {/* Architectural background lines */}
        <div className="absolute inset-0 opacity-20 pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-full bg-[linear-gradient(to_right,#ffffff0a_1px,transparent_1px),linear-gradient(to_bottom,#ffffff0a_1px,transparent_1px)] bg-[size:3rem_3rem]"></div>
        </div>
      ...
      <div className="w-full lg:w-1/2 bg-[#0B1020] flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-20 border-l border-white/5">
        ...
        <div className="max-w-md w-full mx-auto space-y-8 text-left rtl:text-right">
          ...
          <form onSubmit={handleStandardLoginSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative border border-white/10 rounded-lg glass px-3 py-2.5 flex items-center gap-2.5 focus-within:border-brand-primary/50 transition">
                ...
                <input 
                  ...
                  className="w-full text-xs text-white bg-transparent focus:outline-none placeholder-slate-500 font-sans"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative border border-white/10 rounded-lg glass px-3 py-2.5 flex items-center gap-2.5 focus-within:border-brand-primary/50 transition">
                ...
                <input 
                  ...
                  className="w-full text-xs text-white bg-transparent focus:outline-none placeholder-slate-500 font-mono"
          ...
          <div className="pt-6 border-t border-white/5 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
              ...
              <button
                ...
                className="p-2.5 glass hover:glass-dark border border-white/5 rounded-lg text-left rtl:text-right cursor-pointer transition flex flex-col justify-between h-24 hover:border-brand-primary/30"
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[10px] font-bold text-white font-serif leading-none">{t('clientBusinessLabel')}</p>
                </div>
                <div>
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[10px] font-bold text-white font-serif leading-none">{t('accountantProLabel')}</p>
                </div>
                <div>
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[10px] font-bold text-white font-serif leading-none">{t('platformAdminLabel')}</p>
                </div>
                <div>
